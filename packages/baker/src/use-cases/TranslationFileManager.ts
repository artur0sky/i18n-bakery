/**
 * 🥯 i18n-bakery - Translation File Manager (Use Case Layer)
 * 
...
import { Locale, Namespace, Key } from '@i18n-bakery/core';
...
export class TranslationFileManager {
  ...
  async createOrUpdateEntry(
    ...
    if (this.debug) {
      console.log(`[TranslationFileManager] Variable signature:`, signature, '→', signatureKey);
    }
